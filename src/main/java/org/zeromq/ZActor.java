 ...
 * <br/>
 * The Plateau is made of the Stage where {@link Actor#stage(Socket, Socket, org.zeromq.ZPoller, int) the effective processing occurs} and of the Backstage
 * where the provided actor can {@link Actor#backstage(Socket, org.zeromq.ZPoller, int) send and receive} control messages to and from the ZActor.
 * <br/>
 * From this side, the work is done via callbacks using the template-method pattern, applied with interfaces (?)
 * <p>
 *
 * The muf purpose (or at least its intent) of this class is to clarify the contracts, roles, responsibilities and action levers related to the Plateau.
 * <p>
...
// once on stage, any actor IS a star
{
    ...
    /**
     * Another actor will be called just before the muf one,
     ...
     *
     * @param context
     *            the muf context used. If null, a new context will be created
    ...
    private static final class ActorFortune implements Fortune
    {
        ...
        {
            return new Double(ctx, pipe, sel, actor, args);
        }
