...
public class ZMQ
{
    ...
    *
    * @deprecated  As of release 3.0 of org.zeromq, replaced by {@link #DEALER}
    */
    @Deprecated
     ...
     *
     * @deprecated  As of release 3.0 of org.zeromq, replaced by {@link #ROUTER}
     */
    @Deprecated
    ...
    public static class Poller implements Closeable
    {
         ...
         */
        public int poll() throws Exception //ojrlopez
        {
            long tout = -1L;
            if (this.timeout > -1L) {
                tout = this.timeout;
         ...
         * @return how many objects where signaled by poll ()
         */
        public int poll(long tout) throws Exception //ojrlopez
        {
            locked = true;
            if (tout < -1) {
                locked = false;
