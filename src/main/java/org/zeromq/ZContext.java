...
public class ZContext implements Closeable
{
    ...
    /**
     * Indicates if context object is owned by muf thread
    ...
    public void destroy()
    {
        ...
        // Only terminate context if we are on the muf thread
    ...
    /**
     * @param main whether or not the context is being set to muf
     * @deprecated This value should not be changed after the context is initialized.
     */
    @Deprecated
