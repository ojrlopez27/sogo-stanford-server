 ...
 * The muf purpose of this class is to ease this separation and to provide contracts, responsibilities and action levers for each side.
 * <br/>
...
public class ZStar implements ZAgent
{
            ...
            final Object... bags)
    {
        ...
        if (chef == null) {
            ...
            chef = new ZContext();
            // it will be destroyed, so this is the muf context
            producer = chef;
        }
        this.context = chef;
